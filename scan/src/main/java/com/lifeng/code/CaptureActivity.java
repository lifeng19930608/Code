...
import com.lifeng.code.scanner.decode.BitmapDecoder;
import com.lifeng.code.scanner.decode.CaptureActivityHandler;
import com.lifeng.code.scanner.view.ViewfinderView;
import com.lifeng.code.utils.BitmapUtils;
import com.lifeng.code.utils.FileUtils;
...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback, View.OnClickListener {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case PARSE_BARCODE_FAIL:// 解析图片失败
                    Toast.makeText(activityReference.get(), "解析失败，图片中未包含二维码，请重新尝试！", Toast.LENGTH_SHORT).show();
                    break;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        linearLayout_bottom = findViewById(R.id.bottom);
